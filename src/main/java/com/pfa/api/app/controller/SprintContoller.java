...
public class SprintContoller {
   private final SprintService sprintService;
    ...
    public ResponseEntity<JsonResponse> CreateSprint(@RequestBody SprintDTO entity) throws NotFoundException{
        ...
        return new ResponseEntity<JsonResponse>(new JsonResponse(201, "Sprint has been Created successfully"), HttpStatus.CREATED);
    }

    @GetMapping
    public ResponseEntity <List <SprintResponse>>getSprints()throws NotFoundException{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<JsonResponse> adjustSprint(@PathVariable Long id, @RequestBody SprintDTO sprintDTO)throws NotFoundException {
